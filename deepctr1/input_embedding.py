...
def get_linear_logit(linear_emb_list, dense_input_dict, l2_reg,multi_n=1):
    ...
    if len(dense_input) > 0:
        ...
        linear_dense_logit = Dense(
            multi_n, activation=None, use_bias=False, kernel_regularizer=l2(l2_reg))(dense_input__)
